...
categories = {
    ...
    "organizacao-de-espacos": {
        ...
        "articles": [
            ("artigo-17.html", "Como organizar uma cozinha de 6mÂ²: soluções que cabem no orçamento", "Organizar cozinha pequena", "Otimize o espaço da sua cozinha pequena com dicas baratas e práticas."),
            ...
            ("artigo-20.html", "Como dividir um quarto pequeno em 2 ambientes (dormitório + home office)", "Dividir um quarto pequeno em 2 ambientes", "Aprenda a dividir um cÃ´modo mantendo a organização e a estética."),
    ...
    "produtos-e-ferramentas": {
        ...
        "articles": [
            ...
            ("artigo-26.html", "Comparativo: Vassoura vs. rodo â€“ qual limpa melhor?", "Vassoura vs. rodo", "Entenda quando usar a vassoura e o rodo para diferentes superfícies."),
...
# --- NEW ARTICLE GENERATION LOGIC ---
local_images = [
    "../imagens/artigos/cadeira_balanca.jpg",
    "../imagens/artigos/cheiro_queimado.jpg",
    "../imagens/artigos/cozinha_pequena.jpg",
    "../imagens/artigos/fechadura_capa.jpg",
    "../imagens/artigos/ferramentas_basicas.jpg",
    "../imagens/artigos/pia_entupida.jpg",
    "../imagens/artigos/tirar_mofo.jpg"
]
...
for cat_slug, cat_data in categories.items():
    for art in cat_data["articles"]:
        ...
        img1 = random.choice(local_images)
        img2 = random.choice(local_images)
        img3 = random.choice(local_images)
        
        intro_paragraphs = f"""
        <p>Aprender sobre <strong>{keyword}</strong> é essencial para manter a harmonia e o bom funcionamento da sua casa. Ao longo deste guia, você vai entender as melhores técnicas, quais ferramentas utilizar e como evitar erros comuns. {desc}</p>
        <p>Muitas pessoas gastam centenas de reais chamando profissionais para resolver problemas que poderiam ser facilmente solucionados com um pouco de paciência. Hoje, vamos desmistificar o processo para você.</p>
        """
        
        step_paragraphs = f"""
        <p><strong>Passo 1: Preparação.</strong> Antes de iniciar, limpe a área e separe todas as ferramentas indicadas acima. A organização é a chave para o sucesso de qualquer reparo ou projeto doméstico.</p>
        <p><strong>Passo 2: Execução.</strong> Com cuidado, aplique a técnica recomendada para resolver a questão principal. Faça movimentos firmes e não tenha pressa. Se sentir resistência, pare e avalie a situação.</p>
        <p><strong>Passo 3: Finalização.</strong> Após concluir a etapa principal, limpe os resíduos e faça um teste prático. Certifique-se de que o problema foi resolvido permanentemente e que a estrutura está segura.</p>
        """
        
        tips_paragraphs = f"""
        <p>Uma dica de ouro para quem está lidando com <strong>{keyword}</strong> pela primeira vez é não forçar as peças. Além disso, manter a manutenção em dia evita que o problema se repita no futuro.</p>
        <p>Sempre guarde os manuais das suas ferramentas e anote os passos que você seguiu. Assim, da próxima vez, a tarefa será ainda mais rápida e fácil!</p>
        """
        ...
        <article class="article-content">
            <div class="article-header">
                ...
                <div class="article-meta">
                    ...
                    <span>Leitura estimada: 5 minutos</span>
                </div>
            </div>
            
            <img src="{img1}" alt="{title}" class="article-cover" style="width:100%; max-height: 400px; object-fit: cover; border-radius: 8px;">
            
            <p>Se você está buscando uma solução simples e prática para {keyword}, você está no lugar certo. Nosso guia detalhado foi preparado especialmente para leigos e iniciantes.</p>
            ...
            <div class="info-box" style="background: #e8f4f8; padding: 1rem; border-left: 4px solid #3498db; margin: 1.5rem 0;">
                <strong>Resumo Rápido:</strong> Antes de iniciar qualquer reparo ou limpeza, certifique-se de que a área está isolada. Desligue a chave geral se necessário.
            </div>
            
            <h2 id="materiais">2. Ferramentas e materiais necessários</h2>
            <img src="{img2}" alt="Materiais" loading="lazy" style="width:100%; max-height: 300px; object-fit: cover; border-radius:8px; margin:2rem 0;">
            <p>Para concluir essa tarefa, você vai precisar dos seguintes itens:</p>
            <ul>
            ...
            <img src="{img3}" alt="Cuidado com erros" loading="lazy" style="width:100%; max-height: 300px; object-fit: cover; border-radius:8px; margin:2rem 0;">
            
            <div class="warning-box" style="background: #fdf3e7; padding: 1rem; border-left: 4px solid #e67e22; margin: 1.5rem 0;">
                <strong>Aviso de Segurança:</strong> Não utilize produtos químicos não homologados ou force parafusos além do limite.
            </div>
            ...
            <div class="faq-section">
                <div class="faq-item" style="margin-bottom: 1.5rem;">
                    <h4 style="margin-bottom: 0.5rem;">Vale a pena tentar resolver sozinho?</h4>
                    <p>Sim, seguindo os passos indicados com segurança, você economiza muito.</p>
                </div>
                <div class="faq-item" style="margin-bottom: 1.5rem;">
                    <h4 style="margin-bottom: 0.5rem;">Quando devo chamar um profissional?</h4>
                    <p>Se o problema envolver fiação estrutural da casa ou encanamentos rompidos na parede.</p>
                </div>
            </div>
            
            <div class="author-box" style="display: flex; gap: 1rem; align-items: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #eee;">
                <div>
                    <h3 style="margin-bottom: 0.5rem;">Equipe Conserte Agora</h3>
                    <p style="font-size: 0.9rem; color: #666;">Especialistas em criar tutoriais de manutenção, limpeza e pequenos reparos. Todos os nossos guias são testados na prática para garantir que qualquer pessoa consiga segui-los.</p>
                </div>
            </div>
        </article>
        """
...
static_pages = {
    "sobre.html": ("Sobre Nós", "Conheça o Conserte Agora e nosso propósito editorial.", "<h1>Sobre o Conserte Agora</h1><p>Somos um portal dedicado a ensinar soluções práticas e econÃ´micas para o dia a dia da sua casa.</p>"),
